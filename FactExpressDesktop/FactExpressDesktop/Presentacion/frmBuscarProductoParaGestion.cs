...
{
    public partial class frmBuscarProductoParaGestion : Form
    {
        ...
        public frmBuscarProductoParaGestion()
        {
            InitializeComponent();
        }

        private void frmBuscarProductoParaGestion_Load(object sender, EventArgs e)
        {
            cargarProductosAll();
        }
