...
{
    public partial class frmBuscarClienteParaGestion : Form
    {
        ...
        public frmBuscarClienteParaGestion()
        {
            InitializeComponent();
        }

        private void frmBuscarClienteParaGestion_Load(object sender, EventArgs e)
        {
            cargarClientesAll();
        }
